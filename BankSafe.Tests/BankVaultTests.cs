...
namespace BankSafe.Tests
{
    public class BankVaultTests
    {
        ...
        [Test]
        public void WhenRemoveAndCellDoesNotExist_ShouldThrowException()
        {
            Exception ex = Assert.Throws<ArgumentException>((() =>
                    {
        ...
        [Test]
        public void WhenRemoveAndItemDoesNotExist_ShouldThrowException()
        {
            Exception ex = Assert.Throws<ArgumentException>((() =>
                    {
        ...
        [Test]
        public void WhenRemoveAndItemExists_ShouldReturnCorrectMessage()
        {
            vault.AddItem("A2", item);
        ...
        [Test]
        public void WhenRemoveAndItemExists_ShouldMakeTheCellNull()
        {
            vault.AddItem("A2", item);
        ...
        [Test]
        public void Ctor_WhenVaultIsInitialized_ShouldHaveCorrectCells()
        {
